...
def index():
    ...
    if flask.request.method == 'POST':
        ...
        try:
            ...
            predictions, fasta, csv, csv2 = predict_full(sequence)
            plot = create_plot(predictions, sequence)
        except Exception as e:
            print('exception: {}'.format(str(e)))
            return flask.render_template("try_again.html")

    return flask.render_template("results.html", name='ADPred', plot=plot, csv_data=csv, csv_data_smooth=csv2)
